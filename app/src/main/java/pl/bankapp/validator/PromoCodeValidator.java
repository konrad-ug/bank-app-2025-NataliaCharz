...
public class PromoCodeValidator {
     ...
     * Kod promocyjny ma format "PROMO_XYZ", gdzie XYZ to dowolne trzy znaki.
     */
    ...
    /**
     * Feature 5 - zastosowanie kodu promocyjnego przy zakładaniu konta osobistego.
     * Kod promocyjny jest ważny tylko dla osób urodzonych po 1960 roku.
     */
