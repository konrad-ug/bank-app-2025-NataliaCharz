...
public class PersonalAccountTest {
    ...
    public void shouldReturnInvalidDuringPeselValidation(String pesel) {
        ...
        Exception exception = assertThrows(
                ...
                () -> new PersonalAccount(name, surname, pesel));
        //then
        assertTrue(exception.getMessage().contains("Invalid PESEL format."));
    }
    ...
    public void testPeselInvalidWhenNull() {
        ...
        Exception expected = assertThrows(IllegalArgumentException.class,
                () -> new PersonalAccount(name, surname, null));
        //then
        assertTrue(expected.getMessage().contains("Invalid PESEL format."));
    }
